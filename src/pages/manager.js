            ...
            <div className="row g-0">
                <div className="col-md-6 border-end">
                    <ul className="d-flex align-items-center justify-content-between border-bottom py-2 px-3 mb-3">
                        <li><a href="#" className=" text-uppercase font-12px btn btn-outline-info py-2 lh-1 listlinkcolor" ><i className="bi bi-chevron-left lh-1 font-16px"></i> previours</a></li>
                        <li><a href="#" className=" text-uppercase font-12px btn btn-outline-info py-2 lh-1 listlinkcolor" >next <i className="bi bi-chevron-right lh-1 font-16px"></i></a></li>
                    </ul>
                   <MatchList/>
                </div>
