...
const standing= ({checked,TeamStandingdata}) => {

    console.log(TeamStandingdata)
  return (
    <div>
   <div className="text-center mb-3">
        ...
        <div className="d-flex align-items-center gap-2 mb-3">
                <div>
                    <select className=" select-box border-0" data-minimum-results-for-search="Infinity">
                ...
                <div>
                    <select className="select-box form-control" data-minimum-results-for-search="Infinity" 
                    style={{"minWidth":"90px"}}>
        ...
        <table className=" table table-borderless align-middle table-sm mt-3 table-hover tableStyle">
            ...
            <tbody>
            {TeamStandingdata.map((data , index) => (
