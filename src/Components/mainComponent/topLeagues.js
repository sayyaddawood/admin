...
const Topleagues = () => {
    ...
    return (
        <div className=" mb-4">
                ...
                <div className="accordion-item overflow-hidden rounded-3 border-0">
                    ...
                    <div id="Topleagues1.1" className="accordion-collapse collapse" aria-labelledby="Topleagues1.1" data-bs-parent="#accordionExample2">
                        <div className="accordion-body p-0">
                            <ul className="py-2">
                                <Link to='/competition/16' className=" text-primary-hover" >
            ...
            <ul>
                <Link to='/competition/7' className=" text-primary-hover" >
                    <li><a className=" text-dark py-1 px-2 d-flex align-items-center justify-content-between  hover-bg-gray rounded-2 hoverstyle">
                ...
                <Link to='/competition/679' className=" text-primary-hover" >
                    <li><a className=" text-dark py-1 px-2 d-flex align-items-center justify-content-between  hover-bg-gray rounded-2 hoverstyle">
                ...
                <Link to='/competition/17' className=" text-primary-hover" >
